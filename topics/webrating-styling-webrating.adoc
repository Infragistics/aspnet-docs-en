...
The WebRating control allows you to set custom images and styles for a unique look and feel. WebRating exposes the  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.editorcontrols.webrating~customimages.html[CustomImages]"]  and  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.editorcontrols.webrating~ratingimage.html[RatingImage]"]  properties that you can use to customize the look of the control.
...
[NOTE]
====
When using custom images you must set the  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.editorcontrols.webrating~imageheight.html[ImageHeight]"]  and  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.editorcontrols.webrating~imagewidth.html[ImageWidth]"]  properties on WebRating to define the image size.
====
