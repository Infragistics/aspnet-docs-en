...
You can set the DataMode property to one of the members in the  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.editorcontrols.maskdatamode.html[MaskDataMode]"]  enumeration, either by using the Microsoft® Visual Studio® Property Window or by using the following code:
