...
pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.labelappearance~font.html[Font]"]  -- This value specifies the font (e.g., Trebuchet MS) of the labels.
