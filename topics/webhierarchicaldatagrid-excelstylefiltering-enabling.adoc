...
| link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.gridcontrols.columnfilteringsetting.html[Enable (of ColumnSetting)]
| _false_ 
...
B. In the right-hand side panel, *set the* * link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.gridcontrols.filtering~filtertype.html[FilterType]* *property to*  _ExcelStyleFilter_  .
