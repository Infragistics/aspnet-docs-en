...
The  pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.radialgauge~scales.html[Scales]"]  property of the WebGauge control is used to display a range of values on your Linear or Radial gauge. Scales are used to show the start and end measuring point for your gauge.
