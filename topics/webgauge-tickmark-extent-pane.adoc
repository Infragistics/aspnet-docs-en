...
pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.gaugescaletickmarkappearance~startextent.html[Start]"]  -- Set this value to an integer from 0 to 100. This value sets the start position of the tick mark.

pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.gaugescaletickmarkappearance~endextent.html[End]"]  -- Set this value to an integer from 0 to 100. This value sets the end position of the tick mark.
