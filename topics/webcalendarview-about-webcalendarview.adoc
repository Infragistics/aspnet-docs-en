...
The WebCalendarView displays any days with  pick:[asp-net="link:{ApiPlatform}webui.webschedule{ApiVersion}~infragistics.webui.webschedule.appointment.html[Appointments]"]  in a highlighted style. To help you easily locate days that you are available for appointments.
