...
pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.gauge~margin.html[Units]"]  -- This value specifies the unit of measurement for the gauge. The gauge can be measured in pixels or as a percentage of the Gauge control.
