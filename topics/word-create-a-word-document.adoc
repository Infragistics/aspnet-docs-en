...
This topic illustrates how to create a Word document using the forward-only link:{ApiPlatform}webui.documents.io{ApiVersion}~infragistics.documents.word.worddocumentwriter.html[WordDocumentWriter] streamer object. The static Create method of the WordDocumentWriter object creates a new Word document.
