...
[start=6]
. Set the link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.gridcontrols.webhierarchicaldatagrid~datasourceid.html[DataSourceID] property of WebHierarchicalDataGrid to "XmlDataSource1", the ID of the XmlDataSource control.
[start=7]
