...
[start=5]
. Set WebExplorerBar's  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.navigationcontrols.webexplorerbar~datasourceid.html[DataSourceID]"]  property to XmlDataSource1, the id of the XmlDataSource component.
[start=6]
...
.. Create a  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.navigationcontrols.explorerbaritembinding.html[ExplorerBarItemBinding]"]  object and set its  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.navigationcontrols.explorerbaritembinding~datamember.html[DataMember]"]  property to "Category".
.. Set the  pick:[asp-net="link:{ApiPlatform}web{ApiVersion}~infragistics.web.ui.navigationcontrols.explorerbaritembinding~textfield.html[TextField]"]  property to "CategoryName".
