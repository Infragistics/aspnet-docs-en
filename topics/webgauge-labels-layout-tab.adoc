...
The  pick:[asp-net="link:{ApiPlatform}webui.ultrawebgauge{ApiVersion}~infragistics.ultragauge.resources.radialgaugescale~labels.html[Labels]"]  property of the WebGauge control represents values on the scale. Labels are numeric or text values that are associated with values of the scale.
